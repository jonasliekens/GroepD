 ...
 * Date: 26/02/13 11:35
 */
public class MyTripsFragment extends ListFragment {
    ...
    private void downloadList() {
        MyTripsTask myTripsTask = new MyTripsTask();
        myTripsTask.execute();
    }
...
//    }
    ...
    public class MyTripsTask extends AsyncTask<String, String, List<Trip>> {
        ...
        protected List<Trip> doInBackground(String... data) {
            try {
                ...
                String result = restHttpConnection.doGet(String.format(Utilities.MY_TRIPS_ADDRESS, settings.getInt("userId", 0)));
        ...
        protected void onPostExecute(List<Trip> trips) {
            ...
            MyTripsFragment.this.trips = trips.toArray(new Trip[trips.size()]);
            fillList();
        }
    }
}